      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-white/60 leading-relaxed max-w-xs">Premium compression activewear designed for recovery and improved performance. Flow through your day with confidence.</p>
          </div>
