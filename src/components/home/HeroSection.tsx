...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] gradient-hero overflow-hidden">
      ...
      {/* Press Logos Ticker */}
      <div className="absolute bottom-0 left-0 right-0 bg-dark-charcoal py-4 overflow-hidden">
        <div className="flex animate-ticker whitespace-nowrap">
          {[...Array(2)].map((_, setIndex) => (
            <div key={setIndex} className="flex items-center gap-20 px-10">
              <span className="font-serif text-xl text-dark-charcoal-foreground/90">Vogue</span>
              <span className="font-serif text-xl text-dark-charcoal-foreground/90 italic">Forbes</span>
              <span className="font-serif text-xl text-dark-charcoal-foreground/90">GQ</span>
              <span className="font-serif text-xl text-dark-charcoal-foreground/90 italic">Elle</span>
              <span className="font-serif text-xl text-dark-charcoal-foreground/90">Men's Health</span>
              <span className="font-serif text-xl text-dark-charcoal-foreground/90 italic">WSJ</span>
              <span className="font-serif text-xl text-dark-charcoal-foreground/90">Hypebeast</span>
              <span className="font-serif text-xl text-dark-charcoal-foreground/90 italic">Runner's World</span>
            </div>
          ))}
        </div>
      </div>
